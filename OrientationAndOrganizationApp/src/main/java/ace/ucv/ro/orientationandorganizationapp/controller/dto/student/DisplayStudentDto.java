...
public class DisplayStudentDto {
    ...
    @NotNull(message = "Study year cannot be null")
    @JsonProperty(value = "studyYear")
    private int studyYear;

    @NotEmpty(message = "Student group year cannot be empty")
    @NotNull(message = "Student group cannot be null")
    @JsonProperty(value = "studentGroup")
    private String studentGroup;

    @NotEmpty(message = "Student subgroup cannot be empty")
    @NotNull(message = "Student subgroup cannot be null")
    @JsonProperty(value = "studentSubgroup")
