...
@Setter @Getter
@AllArgsConstructor
public class StudentDto extends DisplayStudentDto {
    @NotEmpty(message = "Password cannot be empty")
    @NotNull(message = "Password cannot be null")
    @JsonProperty(value = "password")
    private String password;

    public StudentDto(@NotNull(message = "First name cannot be null")
                              ...
                              @NotNull(message = "Student subgroup cannot be null") String studentSubgroup,
                      String password) {
        super(firstName, lastName, address, CNP, phoneNumber, email, dateOfBirth, specialization, studyYear,
